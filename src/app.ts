...
const setupDatabase = async () => {
    try {
        ...
        // Area.hasMany(Persona, { foreignKey: 'id_area', as: 'colaboradores' })
        ...
        // Cargo.hasMany(Persona, { foreignKey: 'id_cargo', as: 'colaboradores' })
        ...
        // Colaborador.belongsTo(DetalleParametro, { foreignKey: 'id_tipodocumento', as: 'tipoDocumento' })
        ...
        // DetalleParametro.hasMany(Persona, { foreignKey: 'id_tipodocumento', as: 'personas' })
        // DetalleParametro.hasMany(Persona, { foreignKey: 'id_cargo', as: 'cargos' })
        ...
        DocumentoTipoCont.belongsTo(DetalleParametro, { foreignKey: 'id_tipocontingencia', as: 'detalleParametro' })
        ...
        // Pais.hasMany(Persona, { foreignKey: 'id_pais', as: 'colaboradores' })
        ...
        // DetalleParametro.belongsToMany(Persona, {
        //     through: GrupoPersona,
        //     foreignKey: 'id_grupo',
        //     otherKey: 'id_persona',
        //     as: 'personasEnGrupo'
