...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.createTable('area', {
      id: {
        type: Sequelize.UUID, // Usar Sequelize.UUID en migraciones
      ...
      updated_at: {
        allowNull: false,
        type: Sequelize.DATE,
        defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') // Específico de MySQL
      },
      ...
      // underscored: true // Esta opción se maneja a nivel de modelo para los nombres de columnas
    });
  },
