...
module.exports = {
  async up(queryInterface, Sequelize) {
     ...
     */
    await queryInterface.createTable('tipo_establecimiento', {
      id: {
        type: Sequelize.UUID,
      ...
      // Table-level options (optional, but good practice for consistency)
      charset: 'utf8mb4',
  ...
  async down(queryInterface, Sequelize) {
     ...
     */
    await queryInterface.dropTable('tipo_establecimiento');
  }
};
