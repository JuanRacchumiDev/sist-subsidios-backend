...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.createTable('cargo', {
      id: {
        type: Sequelize.UUID, // En migraciones, usamos Sequelize.UUID
      ...
      // `underscored: true` en el modelo maneja la convención de nombres de columnas,
      // no es una opción directa para `createTable` en migraciones.
    });
  },
